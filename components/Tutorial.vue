  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <button
          class="bg-green-500 text-white py-2 px-4 rounded mt-4 transition hover:bg-green-400"
          @click="fetchClientText"
        >
          Fetch data
        </button>
        <p></p>
...
export default {
  ...
  methods: {
    async fetchClientText() {
      const { data } = await this.$axios.get('/api/test-client')
